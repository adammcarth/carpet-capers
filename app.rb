...
Mail.defaults do
  delivery_method :smtp, {
    ...
    :port => "587",
    :user_name => "carpetcapers@gmail.com",
    :password => "carpet_capers",
...
post "/send-quote" do
  ...
  quote = params[:quote]
  icebreaker = "Hi there. <br /><br />You're recieving this email because a quote has just been generated by one of our sales team. " +
  "If you think this is a mistake, please disregard this message.<br/><br /><br />"

  mail = Mail.new do
    to email
    from "Carpet Capers"
    subject "Carpet Capers Quote [#{grand_total}]"
    content_type "text/html; charset=UTF-8"
    body "<html><head><style>.wrapper {max-width:500px;margin:0px auto;}th,td{text-align:center;border:1px solid #000;}</style></head>" +
    "<body><div class='wrapper'>" + icebreaker + quote + "</div></body></html>"
  end
